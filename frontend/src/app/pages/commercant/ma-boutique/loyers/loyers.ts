...
import { LoyerService } from '../../../../core/services/commercant/loyer.service';
import { BoutiqueService } from '../../../../core/services/commercant/boutique.service';
import { PortefeuilleService } from '../../../../core/services/commercant/portefeuille.service';
...
@Component({
  selector: 'app-loyers',
  imports: [NgClass, CurrencyPipe, DatePipe, FormsModule],
